...
/**
 * {@link Mixin} target injections for events derived from {@link RenderEntityItem}.class
 *
 * @author Icovid | Icovid#3888
 * @see RenderEntityItem target
 * @since 1.2.0-BETA
 */
...
public abstract class MixinRenderEntityItem {
     ...
     *
     * @author Icovid | Icovid#3888
     * @see RenderEntityItem#func_177077_a(EntityItem, double, double, double, float, IBakedModel) target
     */
    @Overwrite
