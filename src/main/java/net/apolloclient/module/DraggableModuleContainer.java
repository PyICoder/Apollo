...
public class DraggableModuleContainer implements ModContainer {
    ...
    private final Draggable instance;
    /** the name of module */
    ...
    /** the default screen position of module */
     ...
     * @param screenPosition       the default screen position of module
     * @param instance             the instance of the module class for events to be called on
     */
    public DraggableModuleContainer(String name, String description, String author, Category category, String[] aliases, String[] recommendedServersIP,
                                    String[] disallowedServersIP, int priority, boolean enabled, ScreenPosition screenPosition, Object instance) {
        this.name                 = name;
        ...
        this.instance             = (Draggable) instance;
    ...
    /** @return the hashMap of {@link ModuleEvent}s with a list of {@link HandlerEventContainer}s */
    @Override
